...
{
	public class UpdateHabitCommand : IRequest<Habit>
	{
		public Habit Habit { get; set; }
	}

	public class UpdateHabitCommandHandler : IRequestHandler<UpdateHabitCommand, Habit>
	{
		...
		public async Task<Habit> Handle(UpdateHabitCommand request, CancellationToken cancellationToken)
		{
